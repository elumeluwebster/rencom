...
export default function Contact() {
  return (
    <>
      <HeaderDark />
      <div>
        <section className="h-auto mt-24 mb-28 px-4 md:px-28 pb-8">
          <div className="flex flex-col md:flex-row gap-16">
            <div className="flex-1">
              <h2 className="text-3xl md:text-4xl font-regular text-[#0F3D1C] leading-snug">
            ...
            <div className="flex-1">
              <div className="bg-[#F5F5F5] p-6 rounded-2xl shadow-md">
                <h3 className="text-2xl font-regular text-[#0F3D1C] mb-8">
                  Partner With Us
                </h3>
                <form className="space-y-8">
                  <div className="flex flex-col mb-8 md:flex-row gap-4">
                    <input
                      type="text"
                  ...
                  <button
                    type="submit"
                    className="bg-[#387F1A] text-white px-6 py-3 rounded-full w-full md:w-auto"
                  >
                    Contact Us →
                  </button>
                </form>
        ...
        <section className="bg-[#D8E4CA] w-full py-22 px-4 md:px-28">
          <div className="flex flex-col md:flex-row gap-12 md:gap-20">
            <div className="flex-1">
              <p className="text-[#0F3D1C] text-lg md:text-xl font-base">
                Contact Us
              </p>
              <p className="text-[#0F3D1C] mt-4 text-4xl md:text-5xl font-regular leading-snug">
                Get In Touch <br /> with Us
              </p>
            </div>

            <div className="flex-1 flex flex-col gap-2">
              <p className="text-[#000] text-lg md:text-[22px] font-semibold">
                Email
              </p>
