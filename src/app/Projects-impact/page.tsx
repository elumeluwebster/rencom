...
import { projectImpactData } from "@/utils/store";
...
export default function ProjectsImpact() {
  return (
    <>
      <HeaderDark />
      <div className="mt-6 sm:mt-16 md:mt-24 px-4 sm:px-6 md:px-2 pb-10">
        <div className="flex flex-col items-center text-center justify-center mb-5 px-4">
          ...
          <p className="mt-2 text-[16px] sm:text-[16px] xs:text-[12px] leading-[24px] sm:leading-[28px] font-geist max-w-[700px] mx-auto">
            ...
            solutions that <br /> transform lives.
          </p>
        </div>
        ...
        <section className="flex  md:flex-row items-center gap-4 md:gap-4 mt-12 mb-3">
          <div className="flex flex-wrap gap-4 w-full px-4 mb-20">
            {projectImpactData.map((items) => (
              <div
                key={items.num}
                className="group relative w-full h-[350px] sm:h-[450px] rounded-lg overflow-hidden sm:flex-1 sm:basis-[calc(50%-0.5rem)] flex flex-col justify-between"
              >
                <div
                  className="absolute inset-0 bg-cover bg-center transition-transform duration-700 ease-in-out group-hover:scale-110"
                  style={{ backgroundImage: `url('${items.src}.png')` }}
                />

                <div className="absolute inset-0 group-hover:bg-black/30 bg-transparent z-0 transition-colors duration-500"></div>
                ...
                <div className="relative z-10 p-2 flex flex-col justify-between h-full">
                  ...
                  <div className="relative z-10 w-full text-white p-3 mt-auto transition-all duration-500 group-hover:-translate-y-4 flex flex-col items-end justify-end h-full">
                    <div className="flex items-start justify-end gap-2 mt-1 opacity-0 max-h-0 overflow-hidden transition-all duration-300 group-hover:opacity-100 group-hover:max-h-35">
