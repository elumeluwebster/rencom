    ...
    <nav className="mt-9 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-1">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="bg-transparent text-[white] hidden md:flex items-center py-3 px-8 rounded-xl font-extralight font-questrial">
          ...
          <div className="flex items-center md:space-x-4">
            <button
              className="bg-[#FFF] text-[#00330F] px-6 py-3 rounded-full text-sm font-extralight transition-colors duration-200 cursor-pointer hidden md:block"
              onClick={handleClick}
            >
              Contact Us →
            </button>
        ...
        <div
          className={`md:hidden absolute top-full left-4 right-4 bg-[#00330F] rounded-xl shadow-lg py-4 px-6 space-y-4 transition-all duration-300 ease-in-out transform origin-top z-40 text-[white] ${
            isMobileMenuOpen
        ...
        >
          <Link
            href="/about-us"
            className="block hover:text-[#387F1A] text-base font-extralight"
          ...
          <Link
            href="/Contact-us"
            className="block hover:bg-[#25610c] py-2 text-base font-medium"
            onClick={() => setIsMobileMenuOpen(false)}
          >
            Contact Us
          </Link>
